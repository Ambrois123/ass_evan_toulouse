...
import craintes_adoration from "../Data/Sermons/craintes_adoration.mp3"
  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date : </span>02-10-2022</p>
        <p><span>Titre :  </span>Transformons nos craintes en adoration</p>
        <p><span>Prédicateur :  </span>Past Ambroise ADANLEDJI</p>
        <p><span></span> Dans le Ps 113, le psalmiste nous invite à célébrer et à bénir le Nom de l'Eternel. 
        Son nom est digne d'être célébré pour ce qu'il est et pour qu'il fait.</p>          
        </div>
      </div>
      <div className="audioplayer">
        <audio ref={audioPlayer} src={craintes_adoration} preload='metadata'></audio>
