  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date :</span>14-08-2022</p>
        <p><span>Titre :</span>Grâce et vérité pour glorifier Dieu</p>
        <p><span>Prédicateur :</span>Past Ambroise ADANLEDJI</p>
        <p><span></span>
        Dans Jean 8, le Seigneur Jésus transforme 
        la vie de la femme surprise 
        en flagrant délit d'adultère par la grâce et la vérité.
        </p>          
        </div>
      </div>
