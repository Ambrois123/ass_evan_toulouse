  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date : </span>11-09-2022</p>
        <p><span>Titre : </span>Le contentement</p>
        <p><span>Prédicateur : </span>Past Ambroise ADANLEDJI</p>
        <p><span></span>Dans un monde rempli de troubles et de difficultés de tout genre
         , Dieu nous invite à apprendre à trouver en lui notre satisfaction</p>          
        </div>
      </div>
