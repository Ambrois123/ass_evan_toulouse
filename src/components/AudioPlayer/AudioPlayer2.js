...
import Prive from "../Data/Sermons/privedeGrace.mp3"
  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date :</span>21-08-2022</p>
        <p><span>Titre : </span>Ne nous privons pas de la grâce de Dieu</p>
        <p><span>Prédicateur :  </span></p>
        <p><span></span> La vie de Jacob et d'Esaü 
        nous montre l'amertume et les troubles que 
        le croyant peut expérimenter lorsqu'il se prive de 
        la grâce de Dieu.</p>          
        </div>
      </div>
      <div className="audioplayer">
        <audio ref={audioPlayer} src={Prive} preload='metadata'></audio>
