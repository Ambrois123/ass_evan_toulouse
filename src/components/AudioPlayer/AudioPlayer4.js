...
import Jesus from "../Data/Sermons/whoisJesus.mp3"
  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date : </span>01-09-2022</p>
        <p><span>Titre : </span>Qui est Jésus ?</p>
        <p><span>Prédicateur : </span>Past Bob Colban</p>
        <p><span></span>Tous les hommes ont une idée de Christ.
        Mais le plus important est de savoir ce que Jésus dit de lui-même.</p>          
        </div>
      </div>
      <div className="audioplayer">
        <audio ref={audioPlayer} src={Jesus} preload='metadata'></audio>
