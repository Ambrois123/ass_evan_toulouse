...
import PlanDieu from "../Data/Sermons/planParfait.mp3"
  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date : </span>04-09-2022</p>
        <p><span>Titre :  </span>Le plan de Dieu est parfait</p>
        <p><span>Prédicateur : </span>Pst Bob Colban</p>
        <p><span></span>Jésus a accompli exactement, 
        pendant son ministère sur terre, ce que le Père lui a 
        demandé. Il va aussi accomplir dans notre le plan exact du Père.</p>          
        </div>
      </div>
      <div className="audioplayer">
        <audio ref={audioPlayer} src={PlanDieu} preload='metadata'></audio>
