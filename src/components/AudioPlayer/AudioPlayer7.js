...
import Enseigne_nous_prier from '../Data/Sermons/Enseigne_nous_prier.mp3'
  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date : </span>18-09-2022</p>
        <p><span>Titre :  </span>Enseigne-nous à prier</p>
        <p><span>Prédicateur :  </span>Comme les disciples, nous avons besoin
        que le Seigneur nous enseigne à prier</p>
        <p><span></span></p>          
        </div>
      </div>
      <div className="audioplayer">
        <audio ref={audioPlayer} src={Enseigne_nous_prier} preload='metadata'></audio>
