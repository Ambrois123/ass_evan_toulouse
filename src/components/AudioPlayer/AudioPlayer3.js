...
import limite from "../Data/Sermons/Limite_homme.mp3"
  ...
  return (
    <div className='box'>
      <div className='boxInfo'>
        ...
        <div className='info'>
        <p><span>Date : </span>28-08-2022</p>
        <p><span>Titre : </span>Limite des mesures de l'homme</p>
        <p><span>Prédicateur : </span>Past Ambroise ADANLEDJI</p>
        <p><span></span>Dans Jean 6:1-11, Jésus nous enseigne 
        à mettre de côté nos intruments de 
        mesure et plutôt compté sur lui.</p>          
        </div>
      </div>
      <div className="audioplayer">
        <audio ref={audioPlayer} src={limite} preload='metadata'></audio>
